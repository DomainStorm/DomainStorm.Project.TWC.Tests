...
namespace DomainStorm.Project.TWC.Tests
{
    public class TwcC100Tests
    {
        ...
        public async Task TwcC100_03() // driver_2中看到申請之表單內容
        {
            ...
            That(waterNo_driver_2.Text, Is.EqualTo("41101633338"));

            IWebElement applyDate_driver_2 = driver_2.FindElement(By.CssSelector("[sti-apply-date]"));
            That(applyDate_driver_2.Text, Is.EqualTo("2023年06月03日"));
        }
        ...
        [Test]
        [Order(6)]
        public async Task TwcC100_07() // driver_2中勾選消費性用水服務契約
        {
            await TwcC100_06();
        ...
        [Test]
        [Order(7)]
        public async Task TwcC100_08() // driver_2中勾選公司個人資料保護告知事項
        {
            await TwcC100_07();
        ...
        [Test]
        [Order(8)]
        public async Task TwcC100_09() // driver_2中勾選公司營業章程
        {
            await TwcC100_08();
