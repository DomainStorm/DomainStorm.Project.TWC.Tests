...
namespace DomainStorm.Project.TWC.Tests
{
    public class TwcA101Tests
    {
        ...
        public async Task TwcA101_03()
        {
            ...
            var finished = stormTreeView.GetShadowRoot().FindElement(By.CssSelector("storm-tree-node:nth-child(5) >  a[href='#finished']"));
            _actions.MoveToElement(finished).Click().Perform();

            var abandonButton = _wait.Until(ExpectedConditions.ElementIsVisible(By.CssSelector("storm-card[id='finished'] > div.float-end > div:nth-child(3) > button.bg-gradient-danger")));
