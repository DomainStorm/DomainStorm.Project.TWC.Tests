function Import-Department() {
    ...
    $endPoint = "http://localhost:3500/v1.0/invoke/ServiceBus/method/api/import/department"
...
Export-ModuleMember -Function Import-Department
